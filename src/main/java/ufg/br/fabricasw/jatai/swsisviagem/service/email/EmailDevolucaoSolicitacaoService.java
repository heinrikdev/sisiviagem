 ...
 *         Criado em: 07/08/2019 09:19
 **/
@Service
public class EmailDevolucaoSolicitacaoService {
    ...
    private static Logger log = LoggerFactory.getLogger(EmailDevolucaoSolicitacaoService.class.getName());

    private String buildMessage(Pessoa proposto, Long requisicao_id, Solicitacao solicitacao) {

        String message = "Sua requisição " + requisicao_id + ", solicitação de " + solicitacao.tipoSolicitacao() +
